...
MV2_USE_CUDA=1 MV2_ENABLE_AFFINITY=0 MV2_SMP_CMA=0 srun  --mpi=pmi2 --gres=gpu:4 -n 1 -p OCR --job-name=text_detect $CAFFEBIN test  -model=./CNN_test_on_deform.pt -weights=./snapshot/CNN_iter_10000.caffemodel 2>&1| tee ./logs/test_$time.log &
