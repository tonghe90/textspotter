...
class VggNet(object):
	...
	def vgg_16_bn_proto(self, batch_size, stage1_channel_num = 64, phase='TRAIN'):
		n = caffe.NetSpec()
		if phase == 'TRAIN':
		...
		n.conv1_1, n.bn1_1, n.scale1_1, n.relu1_1 = conv_bn_scale_relu(n.data, num_output=stage1_channel_num)
		n.conv1_2, n.bn1_2, n.scale1_2, n.relu1_2 = conv_bn_scale_relu(n.conv1_1, num_output=stage1_channel_num)
		n.pool1 = L.Pooling(n.conv1_2, pool=P.Pooling.MAX, kernel_size=2, stride=2)

		n.conv2_1, n.bn2_1, n.scale2_1, n.relu2_1 = conv_bn_scale_relu(n.pool1, num_output=stage1_channel_num*2)
		n.conv2_2, n.bn2_2, n.scale2_2, n.relu2_2 = conv_bn_scale_relu(n.conv2_1, num_output=stage1_channel_num*2)
		n.pool2 = L.Pooling(n.conv2_2, pool=P.Pooling.MAX, kernel_size=2, stride=2)

		n.conv3_1, n.bn3_1, n.scale3_1, n.relu3_1 = conv_bn_scale_relu(n.pool2, num_output=stage1_channel_num*4)
		n.conv3_2, n.bn3_2, n.scale3_2, n.relu3_2 = conv_bn_scale_relu(n.conv3_1, num_output=stage1_channel_num*4)
		n.conv3_3, n.bn3_3, n.scale3_3, n.relu3_3 = conv_bn_scale_relu(n.conv3_2, num_output=stage1_channel_num*4)
		n.pool3 = L.Pooling(n.conv3_3, pool=P.Pooling.MAX, kernel_size=2, stride=2)

		n.conv4_1, n.bn4_1, n.scale4_1, n.relu4_1 = conv_bn_scale_relu(n.pool3, num_output=stage1_channel_num*8)
		n.conv4_2, n.bn4_2, n.scale4_2, n.relu4_2 = conv_bn_scale_relu(n.conv4_1, num_output=stage1_channel_num*8)
		n.conv4_3, n.bn4_3, n.scale4_3, n.relu4_3 = conv_bn_scale_relu(n.conv4_2, num_output=stage1_channel_num*8)
		n.pool4 = L.Pooling(n.conv4_3, pool=P.Pooling.MAX, kernel_size=2, stride=2)

		n.conv5_1, n.bn5_1, n.scale5_1, n.relu5_1 = conv_bn_scale_relu(n.pool4, num_output=stage1_channel_num*8)
		n.conv5_2, n.bn5_2, n.scale5_2, n.relu5_2 = conv_bn_scale_relu(n.conv5_1, num_output=stage1_channel_num*8)
		n.conv5_3, n.bn5_3, n.scale5_3, n.relu5_3 = conv_bn_scale_relu(n.conv5_2, num_output=stage1_channel_num*8)
		n.pool5 = L.Pooling(n.conv5_3, pool=P.Pooling.MAX, kernel_size=2, stride=2)
		n.conv5_3x3, n.conv5_3x3_relu = conv_relu(n.pool5, num_output=stage1_channel_num*8, kernel_size=3, stride=1, pad=1)
		for num in xrange(4, 1, -1):  # num = 4, 3, 2 
			bottom_string = 'n.conv%s_3x3' % str(num + 1)
			bottom2x_string = ['n.pool1', 'n.pool2', 'n.pool3', 'n.pool4'][num-1]
			exec (upsample_string.replace('(stage)', str(num)).replace('(bottom)', bottom_string).
				replace('(bottom2x)', bottom2x_string).replace('(num_output)', str(2**(num-2)*stage1_channel_num)))
		exec (loss_string.replace('(feature_map)', 'n.conv2_3x3').replace('(labels)', 'n.label'))
		stage1_channel_num=64
		print(stage1_channel_num)
		n.conv6_1, n.bn6_1, n.scale6_1, n.relu6_1 = conv_bn_scale_relu(n.conv2_3x3, num_output=stage1_channel_num*2)
		n.conv6_2, n.bn6_2, n.scale6_2, n.relu6_2 = conv_bn_scale_relu(n.conv6_1, num_output=stage1_channel_num*2)
		n.conv6_3, n.bn6_3, n.scale6_3, n.relu6_3 = conv_bn_scale_relu(n.conv6_2, num_output=stage1_channel_num*2)
		n.pool6 = L.Pooling(n.conv6_3, pool=P.Pooling.MAX, kernel_h=2, stride_h=2, kernel_w=1, stride_w=1)
		n.conv7_1, n.bn7_1, n.scale7_1, n.relu7_1 = conv_bn_scale_relu(n.pool6, num_output=stage1_channel_num*4)
		n.conv7_2, n.bn7_2, n.scale7_2, n.relu7_2 = conv_bn_scale_relu(n.conv7_1, num_output=stage1_channel_num*4)
		n.conv7_3, n.bn7_3, n.scale7_3, n.relu7_3 = conv_bn_scale_relu(n.conv7_2, num_output=stage1_channel_num*4)
		n.pool7 = L.Pooling(n.conv7_3, pool=P.Pooling.MAX, kernel_h=2, stride_h=2, kernel_w=1, stride_w=1)
		n.conv8_1, n.bn8_1, n.scale8_1, n.relu8_1 = conv_bn_scale_relu(n.pool7, num_output=stage1_channel_num*8)
		n.conv8_2, n.bn8_2, n.scale8_2, n.relu8_2 = conv_bn_scale_relu(n.conv8_1, num_output=stage1_channel_num*8)
		n.conv8_3, n.bn8_3, n.scale8_3, n.relu8_3 = conv_bn_scale_relu(n.conv8_2, num_output=stage1_channel_num*8)
		n.pool8 = L.Pooling(n.conv8_3, pool=P.Pooling.MAX, kernel_h=2, stride_h=2, kernel_w=1, stride_w=1)
		return n.to_proto()