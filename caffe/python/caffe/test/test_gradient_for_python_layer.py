...
def test_gradient_for_python_layer(input_names_and_values, output_names, py_module, py_layer, param_str=None,
                                   propagate_down=None, bp_top=None):
    """
    ...
    :param bp_top:                  optional, list of booleans same length as len(output_names)
    ...
    loss_weight = 2.0
    gradient_test_for_net(net, input_names_and_values, propagate_down, output_names, thr, h, loss_weight, bp_top)
...
def gradient_test_for_net(net, input_names_and_values, propagate_down, output_names, thr, h, loss_weight, bp_top):
    # set inputs
    for in_ in input_names_and_values:
