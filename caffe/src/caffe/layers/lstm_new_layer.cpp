...
void LSTMNewLayer<Dtype>::RecurrentInputBlobNames(vector<string>* names) const {
  names->resize(2);
  (*names)[0] = "h_0";
  (*names)[1] = "c_0";
}
...
template <typename Dtype>
void LSTMNewLayer<Dtype>::RecurrentOutputBlobNames(vector<string>* names) const {
  names->resize(2);
...
template <typename Dtype>
void LSTMNewLayer<Dtype>::RecurrentInputShapes(vector<BlobShape>* shapes) const {
...
template <typename Dtype>
void LSTMNewLayer<Dtype>::OutputBlobNames(vector<string>* names) const {
  names->resize(1);
  (*names)[0] = "h";
}

template <typename Dtype>
void LSTMNewLayer<Dtype>::FillUnrolledNet(NetParameter* net_param) const {
  const int num_output = this->layer_param_.recurrent_param().num_output();
